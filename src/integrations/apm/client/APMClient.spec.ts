      ...
      (done) => {
        apmClient.init(testConfig).subscribe(() => {
          expect(document.body.innerHTML)
            .toEqual(`<div id="test-placement"><div class="st-apm-button"><img src="${zipIconEncoded}" alt="${APMName.ZIP}" id="ST-APM-${APMName.ZIP}" class="st-apm-button__img"></div></div><div id="test-placement-2"><div class="st-apm-button"><img src="${zipIconEncoded}" alt="${APMName.ALIPAY}" id="ST-APM-${APMName.ALIPAY}" class="st-apm-button__img"></div></div>`);
          done();
        });
      });
