...
//   const { instance, jwt, requestid, fullResponse, ridRegex, sentryServiceMock } = instanceFixture();
//
...
//       // @ts-ignore
//       spy = jest.spyOn(instance.getNotification(), 'error');
//       // @ts-ignore
...
//       instance.updateJwt('somenewjwt');
//       expect((instance as any).messageBus.publish).toHaveBeenCalledWith(messageBusEvent);
//     });
//   });
//
