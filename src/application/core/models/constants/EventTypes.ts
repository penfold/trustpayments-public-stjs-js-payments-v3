...
export const PUBLIC_EVENTS = {
  ...
  THREE_D_SECURE_SETUP: 'ST_THREE_D_SECURE_SETUP',
  THREE_D_SECURE_TRIGGER: 'ST_THREE_D_SECURE_TRIGGER',
  THREE_D_SECURE_START: 'ST_THREE_D_SECURE_START',
  THREE_D_SECURE_VERIFY: 'ST_THREE_D_SECURE_VERIFY',
