...
export const PUBLIC_EVENTS = {
  ...
  APPLE_PAY_WALLETVERIFY_STATUS: 'ST_APPLE_PAY_WALLETVERIFY_STATUS',
  APPLE_PAY_AUTHORIZATION_STATUS: 'ST_APPLE_PAY_AUTHORIZATION_STATUS',
  APPLE_PAY_COMPLETE_SESSION: 'ST_APPLE_PAY_COMPLETE_SESSION',
  APPLE_PAY_ABORT_SESSION: 'ST_APPLE_PAY_ABORT_SESSION',
