...
import { LegacyApplePaySessionWrapper } from '../../client/integrations/apple-pay/apple-pay-session-service/LegacyApplePaySessionWrapper';
...
Container.set({ id: ILegacyApplePaySessionWrapper, type: LegacyApplePaySessionWrapper });
