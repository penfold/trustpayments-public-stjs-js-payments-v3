...
Feature: Visa checkout E2E tests
  ...
  Scenario Outline: Visa checkout payment with <request_type> combination of requestTypes and frictionless card
    Given JS library configured by inline params VISA_CHECKOUT_CONFIG and jwt BASE_JWT with additional attributes for VisaCheckout
      | key                     | value          |
...
#    And User confirms visa checkout security code
  ...
  @vueJS
  @react_native @VC_e2e
  Scenario: Visa checkout payment with THREEDQUERY in requestTypes and frictionless card
    Given JS library configured by inline params VISA_CHECKOUT_CONFIG and jwt BASE_JWT with additional attributes for VisaCheckout
      | key                     | value       |
...
#    And User confirms visa checkout security code
  ...
  Scenario Outline: Visa checkout payment with <request_type> combination of requestTypes and non frictionless card
    Given JS library configured by inline params VISA_CHECKOUT_CONFIG and jwt BASE_JWT with additional attributes for VisaCheckout
      | key                     | value          |
      | requesttypedescriptions | <request_type> |
    And User opens example page
...
#    And User confirms visa checkout security code
  ...
  @vueJS
  @react_native
  Scenario: Visa checkout payment with THREEDQUERY in requestTypes and non frictionless card
    Given JS library configured by inline params VISA_CHECKOUT_CONFIG and jwt BASE_JWT with additional attributes for VisaCheckout
      | key                     | value       |
      | requesttypedescriptions | THREEDQUERY |
    And User opens example page
...
#    And User confirms visa checkout security code
  ...
  Scenario Outline: Visa checkout payment with <request_type> combination of requestTypes and frictionless card
    Given JS library configured by inline params VISA_CHECKOUT_CONFIG and jwt JWT_WITH_SUBSCRIPTION with additional attributes for VisaCheckout
      | key                     | value          |
      | requesttypedescriptions | <request_type> |
    And User opens example page
    And User clicks on Visa Checkout button
...
#    And User confirms visa checkout security code
  ...
  Scenario: Successful Authentication by Visa checkout with submit on success config
    Given JS library configured by inline params VISA_CHECKOUT_WITH_SUBMIT_ON_SUCCESS_CONFIG and jwt BASE_JWT with additional attributes for VisaCheckout
      | key                     | value             |
      | requesttypedescriptions | ACCOUNTCHECK AUTH |
    And User opens example page
    And User clicks on Visa Checkout button
  ...
  Scenario: Successful Authentication by Visa checkout with cybertonica config
    Given JS library configured by inline params VISA_CHECKOUT_WITH_CYBERTONICA_CONFIG and jwt BASE_JWT with additional attributes for VisaCheckout
      | key                     | value             |
      | requesttypedescriptions | ACCOUNTCHECK AUTH |
    And User opens example page
    And User clicks on Visa Checkout button
  ...
  Scenario: Successful Authentication by Visa checkout with updateJwt and deferinit true
    Given JS library configured by inline params VISA_CHECKOUT_WITH_DEFERINIT_TRUE_CONFIG and jwt BASE_JWT with additional attributes for VisaCheckout
      | key                     | value             |
      | requesttypedescriptions | ACCOUNTCHECK AUTH |
