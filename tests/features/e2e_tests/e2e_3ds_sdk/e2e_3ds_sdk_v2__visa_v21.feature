...
Feature: 3ds SDK v2 E2E tests - VISA v2.1
  ...
  Scenario Outline: TC_1 - Successful Frictionless Authentication - Card: VISA_V21 Request types: <request_types>
  ...
  Scenario Outline: TC_2 - Failed Frictionless Authentication - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_3 - Attempts Stand-In Frictionless Authentication - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4 - Unavailable Frictionless Authentication from the Issuer - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_5 - Rejected Frictionless Authentication by the Issuer - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_6a - Authentication failed by DS permanent unavailability - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_6b - Authentication success after retry when DS timeout in first call - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_7 - Authentication failed by improper data in ARes message - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_8 - Error not completed threeDSMethod - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_9 - Successful Step Up Authentication - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_10 - Failed Step Up Authentication - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_11 - step up - Error on authentication - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_12 - successful frictionless with require methodUrl - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_13 - step up with require methodUrl - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_14 - successful frictionless with transaction timed out error for method url- Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4a - transaction timed out at athe ACS - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
...
#      | ACCOUNTCHECK THREEDQUERY | Payment has been successfully processed | success  | disabled | Timout in acs/gateway takes more time than wait in tests
  ...
  Scenario Outline: TC_4c - card holder not enrolled in service - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4d - transaction timed out at the ACS - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4e - non-payment transaction not supported - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4f - 3RI transaction not supported - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
