...
Feature: 3ds SDK v2 E2E tests - AMEX v2.1
  ...
  Scenario Outline: TC_1 - Successful Frictionless Authentication - Card: AMEX_V21 Request types: <request_types>
  ...
  Scenario Outline: TC_2 - Failed Frictionless Authentication - Card: AMEX_V21 Request types: <request_types>
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_FRICTIONLESS_FAILED
    And User clicks Pay button
  ...
  Scenario Outline: TC_3 - Attempts Stand-In Frictionless Authentication - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_FRICTIONLESS_STAND_IN
    And User clicks Pay button
    Then User will see notification frame text: "Payment has been successfully processed"
    And User will see following callback type called only once
      | callback_type |
  ...
  Scenario Outline: TC_4 - Unavailable Frictionless Authentication from the Issuer - Card: AMEX_V21 Request types: <request_types>
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_UNAVAILABLE_FRICTIONLESS_AUTH
    And User clicks Pay button
    Then User will see notification frame text: "Payment has been successfully processed"
    And User will see following callback type called only once
      | callback_type |
  ...
  Scenario Outline: TC_5 - Rejected Frictionless Authentication by the Issuer - Card: AMEX_V21 Request types: <request_types>
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_REJECTED_FRICTIONLESS_AUTH
    And User clicks Pay button
    Then User will see notification frame text: "<payment_status>"
    And User will see following callback type called only once
      | callback_type |
  ...
  Scenario Outline: TC_6a - Authentication failed by DS permanent unavailability - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
  ...
  Scenario Outline: TC_7 - Authentication failed by improper data in ARes message - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
  ...
  Scenario Outline: TC_8 - Error not completed threeDSMethod - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
  ...
  Scenario Outline: TC_9 - Successful Step Up Authentication - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
  ...
  Scenario Outline: TC_11 - step up - Error on authentication - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_STEP_UP_AUTH_ERROR
    And User clicks Pay button
    And User see 3ds SDK challenge is displayed
    And User fills 3ds SDK challenge with THREE_DS_CODE and submit
    Then User will see notification frame text: "An error occurred"
  ...
  Scenario Outline: TC_12 - successful frictionless with require methodUrl - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
  ...
  Scenario Outline: TC_13 - step up with require methodUrl - Card: AMEX_V21 Request types: <request_types>
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_NON_FRICTIONLESS_METHOD_URL
    And User clicks Pay button
    And User see 3ds SDK challenge is displayed
    And User fills 3ds SDK challenge with THREE_DS_CODE and submit
    Then User will see notification frame text: "Payment has been successfully processed"
  ...
  Scenario Outline: TC_4b - suspected fraud - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_TRANS_STATUS_SUSPECTED_FRAUD
    And User clicks Pay button
    Then User will see notification frame text: "Payment has been successfully processed"
    And User will see following callback type called only once
      | callback_type |
  ...
  Scenario Outline: TC_4c - card holder not enrolled in service - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_TRANS_STATUS_NOT_ENROLLED
    And User clicks Pay button
    Then User will see notification frame text: "<payment_status>"
    And User will see following callback type called only once
      | callback_type |
  ...
  Scenario Outline: TC_4e - non-payment transaction not supported - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_TRANS_STATUS_TRANSACTION_NON_PAYMENT
    And User clicks Pay button
    Then User will see notification frame text: "Payment has been successfully processed"
    And User will see following callback type called only once
      | callback_type |
  ...
  Scenario Outline: TC_4f - 3RI transaction not supported - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
    ...
    And User opens example page
    And User waits for form inputs to be loaded
    When User fills payment form with defined card AMEX_V21_3DS_SDK_TRANS_STATUS_3RI_TRANSACTION_NOT_SUPPORTED
    And User clicks Pay button
    Then User will see notification frame text: "Payment has been successfully processed"
    And User will see following callback type called only once
      | callback_type |
