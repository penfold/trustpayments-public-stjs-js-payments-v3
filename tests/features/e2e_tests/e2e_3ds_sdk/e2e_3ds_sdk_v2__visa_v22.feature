...
Feature: 3ds SDK v2 E2E tests - VISA v2.2
  ...
  Scenario Outline: TC_6a - Authentication failed by DS permanent unavailability - Card: VISA_V22_3DS_SDK_DS_UNAVAILABLE
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_6b - Authentication success after retry when DS timeout in first call - Card: VISA_V22_3DS_SDK_DS_UNAVAILABLE
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4a - transaction timed out at athe ACS - Card: VISA_V22_3DS_SDK_TRANS_STATUS_AUTH_FAILED
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
...
#      | ACCOUNTCHECK THREEDQUERY | Payment has been successfully processed | success  | disabled | Timout in acs/gateway takes more time than wait in tests
  ...
  Scenario Outline: TC_4b - suspected fraud - Card: VISA_V22_3DS_SDK_TRANS_STATUS_SUSPECTED_FRAUD
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4c - card holder not enrolled in service - Card: VISA_V22_3DS_SDK_TRANS_STATUS_NOT_ENROLLED
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4d - transaction timed out at the ACS - Card: VISA_V22_3DS_SDK_TRANS_STATUS_TRANSACTION_TIMEOUT_AT_ACS
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4e - non-payment transaction not supported - Card: VISA_V22_3DS_SDK_TRANS_STATUS_TRANSACTION_NON_PAYMENT
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4f - 3RI transaction not supported - Card: VISA_V22_3DS_SDK_TRANS_STATUS_3RI_TRANSACTION_NOT_SUPPORTED
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
