...
Feature: 3ds SDK v2 E2E tests with redirection after payment - VISA v2.1
  ...
  Scenario Outline: TC_6 - Authentication failed by DS unavailability - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4a - successful frictionless with transaction timed out at athe ACS - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
...
#      | ACCOUNTCHECK THREEDQUERY | Payment has been successfully processed | should be none | should be none | should be none | #Timout in acs/gateway takes more time than wait in tests
  ...
  Scenario Outline: TC_4b - successful frictionless with suspected fraud - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4c - successful frictionless with card holder not enrolled in service - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
...
#      | ACCOUNTCHECK THREEDQUERY | Payment has been successfully processed | should be none | should be none | should be none | #Timout in acs/gateway takes more time than wait in tests
  ...
  Scenario Outline: TC_4d - successful frictionless with transaction timed out at the ACS - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4e - successful frictionless with non-payment transaction not supported - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
  ...
  Scenario Outline: TC_4f - successful frictionless with 3RI transaction not supported - Card: VISA_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value              |
      | requesttypedescriptions | <request_types>    |
      | sitereference           | jstrustthreed76424 |
