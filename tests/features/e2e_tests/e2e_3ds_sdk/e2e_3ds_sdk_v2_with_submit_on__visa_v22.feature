...
Feature: 3ds SDK v2 E2E tests with redirection after payment - VISA v2.2
  ...
  Scenario Outline: TC_4 - Unavailable Frictionless Authentication from the Issuer - Card: VISA_21 Request types: <request_types>
    Given JS library configured with BASIC_CONFIG and additional attributes
      | key             | value |
      | submitOnSuccess | true  |
    Given JS library authenticated by jwt BASE_JWT with additional attributes
  ...
  Scenario Outline: TC_7 - Authentication failed by improper data in ARes message - Card: VISA_21 Request types: <request_types>
    Given JS library configured with BASIC_CONFIG and additional attributes
      | key          | value |
      | <e2e_config> | true  |
    Given JS library authenticated by jwt BASE_JWT with additional attributes
  ...
  Scenario Outline: TC_9 -Successful Step Up Authentication - Card: VISA_V22_3DS Request types: <request_types>
    Given JS library configured with BASIC_CONFIG and additional attributes
      | key             | value |
      | submitOnSuccess | true  |
    Given JS library authenticated by jwt BASE_JWT with additional attributes
