...
Feature: 3ds SDK v2 E2E tests - AMEX v2.1
  ...
  Scenario Outline: TC_4a - transaction timed out at athe ACS - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
  ...
  Scenario Outline: TC_4d - transaction timed out at the ACS - Card: AMEX_V21 Request types: <request_types>
    Given JS library authenticated by jwt BASE_JWT with additional attributes
      | key                     | value             |
      | requesttypedescriptions | <request_types>   |
      | sitereference           | trustthreeds76424 |
