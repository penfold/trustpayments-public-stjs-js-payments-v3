Feature: 3ds SDK v2 E2E tests - MasterCard v2.2 Threedresponse
  As a user
  ...
  Scenario Outline: Successful payment with sending threedresponse JWT to merchants with Request types: <request_types>
