...
#      | requesttypedescriptions | <request_types> |
    ...
    When User fills custom payment form with defined card MASTERCARD_SUCCESSFUL_AUTH_CARD
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_FAILED_SIGNATURE_CARD
    And User clicks Pay button
    And User fills V1 authentication modal
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card AMERICAN_EXPRESS_FAILED_AUTH_CARD
    And User clicks Pay button
    And User fills V1 authentication modal
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card DISCOVER_PASSIVE_AUTH_CARD
    And User clicks Pay button
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card AMERICAN_EXPRESS_TIMEOUT_CARD
    And User clicks Pay button
   Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card MASTERCARD_NOT_ENROLLED_CARD
    And User clicks Pay button
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card AMERICAN_EXPRESS_UNAVAILABLE_CARD
    And User clicks Pay button
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_MERCHANT_NOT_ACTIVE_CARD
    And User clicks Pay button
    Then User will see payment status information: "<payment_status>"
    And User will see that notification frame has "<color>" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_CMPI_LOOKUP_ERROR_CARD
    And User clicks Pay button
    Then User will see payment status information: "<payment_status>"
    And User will see that notification frame has "<color>" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card MASTERCARD_CMPI_AUTH_ERROR_CARD
    And User clicks Pay button
    And User fills V1 authentication modal
    Then User will see payment status information: "An error occurred"
    And User will see that notification frame has "red" color
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card MASTERCARD_AUTH_UNAVAILABLE_CARD
    And User clicks Pay button
    And User fills V1 authentication modal
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card DISCOVER_BYPASSED_AUTH_CARD
    And User clicks Pay button
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
    And "submit" callback is called only once
