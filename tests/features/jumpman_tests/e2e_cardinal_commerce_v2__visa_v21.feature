...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_SUCCESSFUL_FRICTIONLESS_AUTH
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_FAILED_FRICTIONLESS_AUTH
    And User clicks Pay button
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_FRICTIONLESS
    And User clicks Pay button
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_UNAVAILABLE_FRICTIONLESS_AUTH
    And User clicks Pay button
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_REJECTED_FRICTIONLESS_AUTH
    And User clicks Pay button
    Then User will see payment status information: "<payment_status>"
    And User will see that notification frame has "<color>" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_AUTH_NOT_AVAILABLE_ON_LOOKUP
    And User clicks Pay button
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_ERROR_ON_LOOKUP
    And User clicks Pay button
    Then User will see payment status information: "<payment_status>"
    And User will see that notification frame has "<color>" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_TIMEOUT_ON_CMPI_LOOKUP_TRANSACTION
    And User clicks Pay button
    Then User will see payment status information: "<payment_status>"
    And User will see that notification frame has "<color>" color
    And "submit" callback is called only once
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_NON_FRICTIONLESS
    And User clicks Pay button
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_STEP_UP_AUTH_FAILED
    And User clicks Pay button
    And User fills V2 authentication modal
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_STEP_UP_AUTH_UNAVAILABLE
    And User clicks Pay button
    And User fills V2 authentication modal
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_ERROR_ON_AUTH
    And User clicks Pay button
    And User fills V2 authentication modal
    Then User will see payment status information: "An error occurred"
    And User will see that notification frame has "red" color
...
#      | requesttypedescriptions | <request_types> |
    Given User opens jumpman.html example page
    When User fills custom payment form with defined card VISA_V21_BYPASSED_AUTH
    And User clicks Pay button
    Then User will see payment status information: "Payment has been successfully processed"
    And User will see that notification frame has "green" color
    And "submit" callback is called only once
