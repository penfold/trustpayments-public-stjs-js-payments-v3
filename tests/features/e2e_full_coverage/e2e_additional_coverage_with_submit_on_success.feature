Feature: request type with submit on success - full test coverage

  Scenario Outline: successful payment with request types <request_types> and submit on success - frictionless
