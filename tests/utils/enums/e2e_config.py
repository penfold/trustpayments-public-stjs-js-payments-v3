...
class E2eConfig(Enum):
    ...
    START_ON_LOAD_REQUEST_TYPES_CACHETOKENISE_CONFIG = 'e2eConfigStartOnLoadRequestTypesCachetoken.json'
    ...
    REQUEST_TYPE_RISK_CONFIG = 'e2eConfigRequestTypesRisk.json'
    REQUEST_TYPE_AUTH_CONFIG = 'e2eConfigRequestTypesAuth.json'
    REQUEST_TYPE_ACHECK_CONFIG = 'e2eConfigRequestTypesAcheck.json'
    REQUEST_TYPE_TDQ_CONFIG = 'e2eConfigRequestTypesTdq.json'
    ...
    REQUEST_TYPE_CACHETOKENISE = 'e2eConfigRequestTypesCachetoken.json'
    REQUEST_TYPE_CACHETOKENISE_SUBMIT_ON_ERROR = 'e2eConfigRequestTypesCachetokenSubmitOnError.json'
    INVALID_REQUEST_TYPE_CACHETOKENISE_TDQ_AUTH = 'e2eConfigInvalidRequestTypesCachetokenTdqAuth.json'
