...
class Card(Enum):
    ...
    MASTERCARD_INVALID_EXP_DATE_CARD = '5100 0000 0001', '10/18', CardType.MASTERCARD, 123
    MASTERCARD_INVALID_CVV_CARD = '5100 0000 000', '', CardType.MASTERCARD, 1
    MASTERCARD_SUCCESSFUL_AUTH_CARD = '52000 00000 0000 07', '', CardType.MASTERCARD, 123
    MASTERCARD_FIXED_EXP_DATE_CARD = '52000 00000 00', '09/22', CardType.MASTERCARD, 123
