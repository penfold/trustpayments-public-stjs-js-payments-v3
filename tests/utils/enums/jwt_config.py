...
class JwtConfig(Enum):
    ...
    JWT_DECLINE_VISA_PARENT_TRANSACTION = 'jwt_decline_visa_frictionless_with_parenttransaction.json'
    ...
    JWT_WITH_FRICTIONLESS_CARD_SUBSCRIPTION = 'jwt_config_frictionless_card_subscription.json'
