...
class ApmModulePaymentLocators:
    ...
    zip_phone_number_field: By = (By.ID, 'input-19')
    zip_next_button: By = (By.XPATH, '//*[@id="app"]/div[1]/main/div//form/button[1]')
    zip_phone_code_input_1: By = (By.ID, 'input-31')
    zip_phone_code_input_2: By = (By.ID, 'input-32')
    zip_phone_code_input_3: By = (By.ID, 'input-33')
    zip_phone_code_input_4: By = (By.ID, 'input-34')
    zip_phone_code_input_5: By = (By.ID, 'input-35')
    zip_phone_code_input_6: By = (By.ID, 'input-36')
