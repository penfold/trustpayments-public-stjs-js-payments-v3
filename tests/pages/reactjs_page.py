...
class ReactjsPage(BasePage):
    ...
    def click_personal_data_tab(self):
        self._waits.wait_for_element_to_be_clickable(ReactJsAppLocators.personal_data_tab)
        self._actions.click(ReactJsAppLocators.personal_data_tab)
        self._waits.wait_for_element_to_be_displayed(ReactJsAppLocators.personal_data_title)

    def click_home_tab(self):
        self._waits.wait_for_element_to_be_clickable(ReactJsAppLocators.home_tab)
        self._actions.click(ReactJsAppLocators.home_tab)

    def click_payment_tab(self):
        self._waits.wait_for_element_to_be_clickable(ReactJsAppLocators.payment_tab)
